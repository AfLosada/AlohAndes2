...
public class OfertaService <K extends Operador> {
	...
	/**
	 * Metodo GET que trae a todos los ofertaes en la Base de datos. <br/>
	 * <b>Precondicion: </b> el archivo <em>'conectionData'</em> ha sido inicializado con las credenciales del usuario <br/>
	 * <b>URL: </b> http://localhost:8080/TutorialParranderos/rest/ofertaes <br/>
	 * @return	<b>Response Status 200</b> - JSON que contiene a todos los ofertaes que estan en la Base de Datos <br/>
	 ...
	 * <b>Precondicion: </b> el archivo <em>'conectionData'</em> ha sido inicializado con las credenciales del usuario <br/>
	 * <b>URL: </b> http://localhost:8080/TutorialParranderos/rest/ofertaes/{id} <br/>
	...
	@Path( "{id: \\d+}" )
	@Produces( { MediaType.APPLICATION_JSON } )
	public Response getOfertaById( @PathParam( "id" ) Integer id )
	{
		try{
			AlohAndesTransactionManager<K> tm = new AlohAndesTransactionManager<K>( getPath( ) );
