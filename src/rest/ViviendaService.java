...
import vos.Operador;
@Path("/viviendas")
public class ViviendaService <K extends Operador>{
	...
	/**
	 * Metodo GET que trae a todos los viviendaes en la Base de datos. <br/>
	 * <b>Precondicion: </b> el archivo <em>'conectionData'</em> ha sido inicializado con las credenciales del usuario <br/>
	 * <b>URL: </b> http://localhost:8080/TutorialParranderos/rest/viviendaes <br/>
	 * @return	<b>Response Status 200</b> - JSON que contiene a todos los viviendaes que estan en la Base de Datos <br/>
	...
	public Response getViviendas() {
		...
		try {
			...
			List<Vivienda> viviendaes;
			//Por simplicidad, solamente se obtienen los primeros 50 resultados de la consulta
			viviendaes = tm.getAllViviendaes();
			return Response.status(200).entity(viviendaes).build();
		} 
		catch (Exception e) {
	 ...
	 * <b>Precondicion: </b> el archivo <em>'conectionData'</em> ha sido inicializado con las credenciales del usuario <br/>
	 * <b>URL: </b> http://localhost:8080/TutorialParranderos/rest/viviendaes/{id} <br/>
	...
	@Path( "/vivienda/{id: \\d+}" )
	@Produces( { MediaType.APPLICATION_JSON } )
	public Response getViviendaById( @PathParam( "id" ) Integer id )
	{
		try{
			AlohAndesTransactionManager<K> tm = new AlohAndesTransactionManager<K>( getPath( ) );
