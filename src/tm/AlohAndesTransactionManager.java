...
public class AlohAndesTransactionManager <K extends Operador>
{
	...
	/**
	 * M閠odo que modela la transacci髇 que agrega una sola reserva a la base de datos.
	 * <b> post: </b> se ha agregado la reserva que entra como par醡etro
	...
	/**
	 * M閠odo que modela la transacci髇 que agrega las reservas que entran como par醡etro a la base de datos.
	 * <b> post: </b> se han agregado las reservas que entran como par醡etro
	...
	/**
	 * M閠odo que modela la transacci髇 que actualiza la reserva que entra como par醡etro a la base de datos.
	 * <b> post: </b> se ha actualizado la reserva que entra como par醡etro
	...
	/**
	 * M閠odo que modela la transacci髇 que elimina la reserva que entra como par醡etro a la base de datos.
	 * <b> post: </b> se ha eliminado la reserva que entra como par醡etro
